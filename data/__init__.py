...
from .pill_multilabel_dataset import PillMultilabel
...
def make_dataloader(args, is_train=True):
    root_dir = os.path.join(args.data_root_dir, args.data)

    # Build val_loader
    transform = get_transform(args, is_train=False)
    val_dataset = PillMultilabel(root_dir, phase='test', transform=transform)    
    ...
    train_dataset = PillMultilabel(root_dir, phase='train', transform=transform)
